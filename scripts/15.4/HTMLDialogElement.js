...
(function (global, factory) {
    ...
    /**
     * @return {boolean} whether native <dialog> support is missing or incomplete
     */
    function dialogNeedsPolyfill() {
      var test = document.createElement('dialog');
      return typeof test.showModal !== 'function';
    }
    ...
    if (dialogNeedsPolyfill()) {
      ...
      if (!document.querySelector('style[data-dialog-polyfill]')) {
        var dialogStyle = document.createElement('style');
        dialogStyle.setAttribute('data-dialog-polyfill', '');
      ...
      function registerDialogsInRoot(root) {
        if (root.localName === 'dialog') {
          dialogPolyfill.registerDialog(root);
        }
      ...
      function registerAllDialogs() {
        registerDialogsInRoot(document);
      }

      registerAllDialogs();
      if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', registerAllDialogs);
      }
